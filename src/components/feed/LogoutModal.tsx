  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Frame 2147225863: Title & Buttons (width: 340px, gap: 20px) */}
        <div className="w-full max-w-[340px] flex flex-col items-center gap-5">
          {/* Title: Are you sure you want to Log out? (Sub Header/Sub 01/Semibold: 24px, 600, #FFFFFF) */}
          <h2
            id="logout-modal-title"
            className="w-full text-center text-white text-2xl font-semibold font-['Lato',sans-serif] leading-[140%] tracking-[-0.02em]"
          >
            {title}
          </h2>
          ...
          <div className="w-full flex flex-row items-center justify-center gap-4">
            {/* Confirm Logout button (secondary button: 162px x 40px, #FF4B4B, border 0.5px #FF4B4B) */}
            <button
              type="button"
              onClick={onConfirm}
