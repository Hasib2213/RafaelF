...
export default function FeedNavbar({ onSearch }: FeedNavbarProps) {
  ...
  return (
    <header className="h-20 w-full shrink-0 border-b border-white/20 px-6 flex items-center justify-between gap-6 shadow-[0px_1px_12px_rgba(0,0,0,0.05)] z-20 sticky top-0 backdrop-blur-md bg-[#2B2A7D]/90 [background-image:linear-gradient(90deg,rgba(79,57,246,0.2)_0%,rgba(43,127,255,0.2)_100%)]">
